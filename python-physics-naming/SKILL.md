...
# python-physics-naming — Physics Variable Naming for Python

There is no single authoritative "Python physics naming standard". `python-physics-naming` is the minimal composition that actually carries authority:
